/**
 * FUN_030ddad8 @ 0x030ddad8
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


uint FUN_030ddad8(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if (iVar4 < 0x40) {
    ...
    uVar11 = FUN_030dde40(uVar7,uVar9,0x40 - iVar4);
    uVar6 = (uint)(uVar11 >> 0x20);
    uVar5 = (uint)uVar11;
    lVar12 = FUN_030dd9d0(uVar7,uVar9,iVar4);
    ...
    if ((param_2 ^ uVar7) >> 0x14 != 0) {
      if (iVar2 == 0) {
        ...
        if (iVar4 < 2) {
          uVar7 = FUN_030dde98(param_1,uVar7 + uVar8 * -0x100000 + 0x100000,uVar5,uVar6,0,
