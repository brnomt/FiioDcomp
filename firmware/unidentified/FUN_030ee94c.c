/**
 * FUN_030ee94c @ 0x030ee94c
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


void FUN_030ee94c(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if ((param_1 != 0 || (param_2 & 0x7fffffff) != 0) && (param_3 != 0 || (param_4 & 0x7fffffff) != 0)
    ...
    FUN_030eec4a((int)lVar1,(int)((ulonglong)lVar1 >> 0x20),uVar6 * 0x1000,uVar3 + uVar7,0,
