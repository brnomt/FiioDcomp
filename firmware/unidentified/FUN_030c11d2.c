/**
 * FUN_030c11d2 @ 0x030c11d2
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


void FUN_030c11d2(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if ((param_1 != 0 || (param_2 & 0x7fffffff) != 0) && (param_3 != 0 || (param_4 & 0x7fffffff) != 0)
    ...
    FUN_030c1468((int)lVar1,(int)((ulonglong)lVar1 >> 0x20),uVar6 * 0x1000,uVar3 + uVar7,0,
