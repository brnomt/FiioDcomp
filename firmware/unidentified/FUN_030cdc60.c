/**
 * FUN_030cdc60 @ 0x030cdc60
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


int FUN_030cdc60(byte *param_1,uint *param_2,undefined4 param_3,code *param_4)
...
LAB_030cdd38:
      ...
      if (bVar1 != 0x4c) {
        ...
        if (bVar1 != 0x6a) goto LAB_030cdd46;
        uVar13 = uVar13 | 0x200000;
      }
    }
    else if ((bVar1 != 0x74) && (bVar1 != 0x7a)) goto LAB_030cdd46;
    param_1 = param_1 + 1;
LAB_030cdd46:
    uVar4 = (uint)*param_1;
    ...
    while (!bVar22) {
      ...
      if (bVar21 == bVar23) {
        if (uVar4 == 0x70) {
          ...
          if (uVar4 == 0x67) break;
          if (uVar4 == 0x69) goto LAB_030cde64;
          if (uVar4 == 0x6e) {
          ...
          if (uVar4 != 0x6f) goto LAB_030cdd9a;
          local_88 = (char *)0x8;
        }
        else {
          if (uVar4 == 0x73) {
          ...
          if (uVar4 == 0x75) {
            ...
            if (uVar4 != 0x78) goto LAB_030cdd9a;
            local_88 = (char *)0x10;
          }
        }
LAB_030cdf02:
...
LAB_030cdf80:
        ...
        if (uVar4 == 0x58) {
          local_7c = s_0123456789ABCDEF_030ce078;
        }
        else {
          local_7c = s_0123456789abcdef_030ce064;
        }
        local_80 = &local_50;
        while( true ) {
          if (lVar24 == 0) break;
          lVar24 = FUN_030c1022((int)lVar24,(int)((ulonglong)lVar24 >> 0x20),local_88,0);
        ...
        if (-1 < (int)(uVar13 << 0xf)) {
          iVar3 = FUN_030ce376(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar3;
        }
        ...
        if ((int)(uVar13 << 0xf) < 0) {
          iVar5 = FUN_030ce376(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar5;
        }
...
LAB_030cddf4:
          ...
          iVar5 = FUN_030ce376(uVar4,uVar13,local_2c,param_4);
...
LAB_030cdec4:
      ...
      bVar22 = uVar4 == 0x45;
      if (!bVar22) goto code_r0x030cdd5c;
    }
    goto LAB_030ce0a6;
  }
  goto LAB_030cdd9a;
code_r0x030cdd5c:
  ...
  bVar22 = uVar4 == 0x46;
  if (!bVar22) goto code_r0x030cdd60;
  goto LAB_030cdd4a;
code_r0x030cdd60:
  if (uVar4 != 0x47) {
LAB_030cdd9a:
...
LAB_030ce0a6:
  ...
  if ((puVar20[1] & 0x80000000) == 0) {
    if ((int)(uVar13 << 0x14) < 0) {
      local_38 = &DAT_030ce348;
    }
    else if ((uVar13 & 1) == 0) {
      local_38 = s_0123456789abcdef_030ce064 + 0x10;
    }
    else {
      local_38 = &DAT_030ce34c;
    }
  }
  else {
    local_38 = &DAT_030ce344;
  }
...
LAB_030ce110:
    ...
    local_84 = (char *)0x0;
    FUN_030cd9b0(&local_50,auStack_70,uVar11,uVar12);
    local_7c = pcStack_48;
    local_88 = local_50;
...
LAB_030ce1da:
    ...
    if (uVar4 == 0x45) goto LAB_030ce110;
    if (uVar4 == 0x46) goto LAB_030ce13c;
    if (uVar4 == 0x47) goto LAB_030ce184;
  }
  else if (uVar4 == 0x66) {
LAB_030ce13c:
    local_84 = (char *)0x1;
    ...
    if (uVar4 != 0x67) goto LAB_030ce212;
LAB_030ce184:
    if ((int)pcVar16 < 1) {
      pcVar16 = (char *)0x1;
    }
    ...
    if (-1 < (int)(uVar13 << 0x1c)) {
      pcVar8 = pcStack_48;
      if ((int)pcVar16 <= (int)pcStack_48) goto LAB_030ce1be;
      while( true ) {
...
LAB_030ce1be:
    ...
    if (((int)pcVar16 <= (int)local_4c) || ((int)local_4c < -4)) goto LAB_030ce1da;
    if ((int)local_4c < 1) {
      local_78 = local_4c;
...
LAB_030ce1fe:
      ...
      if ((int)unaff_r10 < (int)pcVar16) goto LAB_030ce1fe;
    }
...
LAB_030ce212:
  ...
  if (local_80 != (char **)0x80000000) {
    ...
    while ((0 < iVar5 || (local_80 != (char **)0x0))) {
      local_80 = (char **)FUN_030c0ff6(local_80,10);
      pbVar15 = pbVar15 + -1;
...
LAB_030ce08c:
  iVar5 = FUN_030ce350(uVar4,uVar13,local_2c,param_4);
  iVar14 = iVar14 + iVar5;
LAB_030ce092:
  param_1 = param_1 + 1;
  goto LAB_030ce096;
