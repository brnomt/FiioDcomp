/**
 * FUN_0302274c @ 0x0302274c
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


undefined4 FUN_0302274c(void)

{
  ...
  *(undefined2 *)((int)puVar2 + 0xe) = 0x2a;
  puVar2[4] = 8;
  iVar3 = FUN_02ffcece(0,0,(int)(char)puVar1[0x34]);
  if (iVar3 != 0) {
    return 0;
  }
  FUN_030221e4();
  FUN_02ff895c(local_98,0x80);
  ...
  *(undefined4 *)(puVar1 + 0x2c) = uVar4;
  ...
  if (iVar5 != 0) {
    ...
    local_98[0] = iVar5;
    if (local_1c8 != 0) {
      iVar5 = FUN_03022346(*(undefined4 *)(puVar1 + 0x34),local_1c8,3,auStack_1d0);
      if (iVar5 == 0) {
        iVar3 = -1;
      }
      else {
