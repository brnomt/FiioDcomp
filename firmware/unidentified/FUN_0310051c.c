/**
 * FUN_0310051c @ 0x0310051c
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


int FUN_0310051c(byte *param_1,uint *param_2,undefined4 param_3,code *param_4)
...
LAB_031005f4:
      ...
      if (bVar1 != 0x4c) {
        ...
        if (bVar1 != 0x6a) goto LAB_03100602;
        uVar13 = uVar13 | 0x200000;
      }
    }
    else if ((bVar1 != 0x74) && (bVar1 != 0x7a)) goto LAB_03100602;
    param_1 = param_1 + 1;
LAB_03100602:
    uVar4 = (uint)*param_1;
    ...
    while (!bVar22) {
      ...
      if (bVar21 == bVar23) {
        if (uVar4 == 0x70) {
          ...
          if (uVar4 == 0x67) break;
          if (uVar4 == 0x69) goto LAB_03100720;
          if (uVar4 == 0x6e) {
          ...
          if (uVar4 != 0x6f) goto LAB_03100656;
          local_88 = (char *)0x8;
        }
        else {
          if (uVar4 == 0x73) {
          ...
          if (uVar4 == 0x75) {
            ...
            if (uVar4 != 0x78) goto LAB_03100656;
            local_88 = (char *)0x10;
          }
        }
LAB_031007be:
...
LAB_0310083c:
        ...
        if (uVar4 == 0x58) {
          local_7c = s_0123456789ABCDEF_03100934;
        }
        else {
          local_7c = s_0123456789abcdef_03100920;
        }
        local_80 = &local_50;
        while( true ) {
          if (lVar24 == 0) break;
          lVar24 = FUN_030fe65a((int)lVar24,(int)((ulonglong)lVar24 >> 0x20),local_88,0);
        ...
        if (-1 < (int)(uVar13 << 0xf)) {
          iVar3 = FUN_03100c32(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar3;
        }
        ...
        if ((int)(uVar13 << 0xf) < 0) {
          iVar5 = FUN_03100c32(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar5;
        }
...
LAB_031006b0:
          ...
          iVar5 = FUN_03100c32(uVar4,uVar13,local_2c,param_4);
...
LAB_03100780:
      ...
      bVar22 = uVar4 == 0x45;
      if (!bVar22) goto code_r0x03100618;
    }
    goto LAB_03100962;
  }
  goto LAB_03100656;
code_r0x03100618:
  ...
  bVar22 = uVar4 == 0x46;
  if (!bVar22) goto code_r0x0310061c;
  goto LAB_03100606;
code_r0x0310061c:
  if (uVar4 != 0x47) {
LAB_03100656:
...
LAB_03100962:
  ...
  if ((puVar20[1] & 0x80000000) == 0) {
    if ((int)(uVar13 << 0x14) < 0) {
      local_38 = &DAT_03100c04;
    }
    else if ((uVar13 & 1) == 0) {
      local_38 = s_0123456789abcdef_03100920 + 0x10;
    }
    else {
      local_38 = &DAT_03100c08;
    }
  }
  else {
    local_38 = &DAT_03100c00;
  }
...
LAB_031009cc:
    ...
    local_84 = (char *)0x0;
    FUN_031003c0(&local_50,auStack_70,uVar11,uVar12);
    local_7c = pcStack_48;
    local_88 = local_50;
...
LAB_03100a96:
    ...
    if (uVar4 == 0x45) goto LAB_031009cc;
    if (uVar4 == 0x46) goto LAB_031009f8;
    if (uVar4 == 0x47) goto LAB_03100a40;
  }
  else if (uVar4 == 0x66) {
LAB_031009f8:
    local_84 = (char *)0x1;
    ...
    if (uVar4 != 0x67) goto LAB_03100ace;
LAB_03100a40:
    if ((int)pcVar16 < 1) {
      pcVar16 = (char *)0x1;
    }
    ...
    if (-1 < (int)(uVar13 << 0x1c)) {
      pcVar8 = pcStack_48;
      if ((int)pcVar16 <= (int)pcStack_48) goto LAB_03100a7a;
      while( true ) {
...
LAB_03100a7a:
    ...
    if (((int)pcVar16 <= (int)local_4c) || ((int)local_4c < -4)) goto LAB_03100a96;
    if ((int)local_4c < 1) {
      local_78 = local_4c;
...
LAB_03100aba:
      ...
      if ((int)unaff_r10 < (int)pcVar16) goto LAB_03100aba;
    }
...
LAB_03100ace:
  ...
  if (local_80 != (char **)0x80000000) {
    ...
    while ((0 < iVar5 || (local_80 != (char **)0x0))) {
      local_80 = (char **)FUN_030fe62e(local_80,10);
      pbVar15 = pbVar15 + -1;
...
LAB_03100948:
  iVar5 = FUN_03100c0c(uVar4,uVar13,local_2c,param_4);
  iVar14 = iVar14 + iVar5;
LAB_0310094e:
  param_1 = param_1 + 1;
  goto LAB_03100952;
