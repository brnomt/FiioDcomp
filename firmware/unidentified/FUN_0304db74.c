/**
 * FUN_0304db74 @ 0x0304db74
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


undefined4 FUN_0304db74(undefined4 param_1,undefined4 *param_2,undefined4 *param_3)
      ...
      if (DAT_0304ddec[0xb] != 1) {
        *param_3 = DAT_0304ddec[8];
        ...
        if (*DAT_0304ddf0 != '\0') {
          ...
          *DAT_0304dddc = 0;
          uVar6 = FUN_03024308();
          FUN_03024334(uVar6,puVar3[7],DAT_0304ddfc,(uint)(puVar3[3] * puVar3[8]) >> 4,&local_30,
                       DAT_0304ddf8);
          do {
            FUN_03019ee0();
          } while (*psVar1 != 1);
        ...
        *DAT_0304dddc = 0;
        uVar6 = FUN_03024308();
        FUN_03024334(uVar6,puVar3[7],DAT_0304de00,(uint)(puVar3[3] * puVar3[8]) >> 4,&local_30,
                     DAT_0304ddf8);
        do {
          FUN_03019ee0();
        } while (*psVar1 != 1);
