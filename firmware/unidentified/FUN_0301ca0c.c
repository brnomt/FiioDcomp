/**
 * FUN_0301ca0c @ 0x0301ca0c
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


undefined4 FUN_0301ca0c(int param_1,int param_2)
...
LAB_0301caac:
  ...
  if ((*(byte *)(param_2 + 0x18) & 0x10) != 0) {
    ...
    uVar2 = FUN_0301c870(local_2c,local_28,uVar4,*(undefined2 *)(param_2 + 0x14));
          ...
          for (uVar7 = 0; uVar7 < uVar3; uVar7 = uVar7 + 1) {
            ...
            if (local_30 == 0) {
              ...
              local_30 = (uint)*(byte *)(*DAT_0301ce60 +
                                        ...
                                        (local_30 - 1));
              FUN_0301c978(param_1 + 0x1c,*DAT_0301ce64 + local_30 * 0xc,local_190);
              for (uVar6 = 0; uVar6 < 3; uVar6 = uVar6 + 1) {
                if (uVar7 == 0) {
