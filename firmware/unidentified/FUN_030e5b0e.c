/**
 * FUN_030e5b0e @ 0x030e5b0e
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


longlong FUN_030e5b0e(uint param_1,int param_2,uint param_3,uint param_4)
