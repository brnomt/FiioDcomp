/**
 * FUN_0306d5cc @ 0x0306d5cc
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


uint FUN_0306d5cc(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if (iVar4 < 0x40) {
    ...
    uVar11 = FUN_0306d522(uVar7,uVar9,0x40 - iVar4);
    uVar6 = (uint)(uVar11 >> 0x20);
    uVar5 = (uint)uVar11;
    lVar12 = FUN_0306d934(uVar7,uVar9,iVar4);
    ...
    if ((param_2 ^ uVar7) >> 0x14 != 0) {
      if (iVar2 == 0) {
        ...
        if (iVar4 < 2) {
          uVar7 = FUN_0306d972(param_1,uVar7 + uVar8 * -0x100000 + 0x100000,uVar5,uVar6,0,
