...
undefined4 FUN_0304fed0(short *param_1,int param_2,int param_3,short *param_4)

{
  ...
  if (local_54 != 0) {
    do {
      ...
      iVar3 = FUN_0304ed3e(param_2,0,iVar6);
      if (iVar3 != 0) {
        return 0;
      }
      local_44 = iVar6;
  ...
  if (sVar1 == 0x70) {
    if (param_1[1] == 0x42) {
      iVar5 = FUN_0304ed3e(param_2,0,*local_40[0] + (uint)(ushort)param_1[0x10]);
      if (iVar5 != 0) {
        return 0;
      }
      local_54 = 0;
...
LAB_0304ffdc:
  ...
  local_54 = (uint)uVar2;
LAB_0305001a:
  iVar5 = FUN_0304ed3e(param_2,0,*local_40[0] + local_54);
  if (iVar5 == 0) {
