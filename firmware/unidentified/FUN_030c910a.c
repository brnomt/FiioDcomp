/**
 * FUN_030c910a @ 0x030c910a
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


undefined4 FUN_030c910a(int *param_1,int *param_2)
  ...
  if (0 < *(int *)(iVar10 + 4)) {
    ...
    do {
      ...
      if (*(char *)(*(int *)(iVar9 + 0x24) + uVar1) == '\0') {
        ...
        iVar2 = FUN_030c4c4e(param_1,*(undefined4 *)(*(int *)(iVar9 + 0x28) + uVar1 * 4));
      }
      else {
        iVar2 = FUN_030c5f38();
        if (0x24 < iVar2) {
...
LAB_030c9320:
  ...
  if (0 < iVar11) {
    do {
      FUN_030ca028(local_64,*(undefined4 *)(param_1[7] + iVar9 * 4));
      iVar9 = iVar9 + 1;
