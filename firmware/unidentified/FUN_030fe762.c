/**
 * FUN_030fe762 @ 0x030fe762
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


ulonglong FUN_030fe762(undefined4 param_1,int param_2,int param_3,int param_4,uint param_5,
...

{
  ...
  if (((uint)uVar5 != 0 || param_3 != 0) || (uVar3 != 0 || param_4 != 0)) {
    if (param_3 != 0 || param_4 != 0) {
      uVar6 = FUN_030fe6bc(param_3,param_4,0x40 - iVar2);
      lVar7 = FUN_030feac8(param_3,param_4,iVar2);
