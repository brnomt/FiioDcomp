...
undefined4
FUN_0302220c(undefined4 param_1,ushort param_2,int param_3,int param_4,int param_5,int param_6,
            ushort *param_7)

{
  ...
  FUN_02ff895c(&local_150,0x134);
  local_14e = (ushort)param_3;
  if (param_4 != 0) {
    local_150 = param_2;
    local_14c = param_4;
    if (param_5 == 0) {
    ...
    if (local_150 == 0x9003) {
      FUN_02ff890e(DAT_030225e8,&uStack_48,local_14c);
    }
    else if (local_150 < 0x9004) {
      if (local_150 == 0x112) {
        *(int *)(DAT_030225e4 + 0x1c) = aiStack_148[0];
      }
      else if (local_150 == 0x201) {
        *(int *)(DAT_030225e4 + 0x28) = aiStack_148[0] + *(int *)(DAT_030225e4 + 4) + 10;
      }
      else if (local_150 == 0x202) {
        *(int *)(DAT_030225e4 + 0x24) = aiStack_148[0];
      }
      else if (local_150 == 0x8769) {
        ...
        *(int *)(param_7 + 2) = local_14c;
        param_7[0x94] = local_28;
        FUN_02ff890e(param_7 + 4,aiStack_148,0x100);
        *param_7 = local_150;
        param_7[1] = local_14e;
      }
    }
    else if (local_150 == 0xa001) {
      *(int *)(DAT_030225e4 + 0x20) = aiStack_148[0];
    }
    else if (local_150 == 0xa002) {
      *(int *)(DAT_030225e4 + 0x14) = aiStack_148[0];
    }
    else if (local_150 == 0xa003) {
