/**
 * FUN_030ac7ec @ 0x030ac7ec
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


longlong FUN_030ac7ec(uint param_1,int param_2,uint param_3,uint param_4)
