/**
 * FUN_030f68ba @ 0x030f68ba
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


longlong FUN_030f68ba(uint param_1,int param_2,uint param_3,uint param_4)
