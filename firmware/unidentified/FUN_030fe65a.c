/**
 * FUN_030fe65a @ 0x030fe65a
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


longlong FUN_030fe65a(uint param_1,int param_2,uint param_3,uint param_4)
