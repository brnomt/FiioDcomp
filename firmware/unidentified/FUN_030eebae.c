/**
 * FUN_030eebae @ 0x030eebae
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


longlong FUN_030eebae(uint param_1,int param_2,uint param_3,uint param_4)
