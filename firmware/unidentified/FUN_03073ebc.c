/**
 * FUN_03073ebc @ 0x03073ebc
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


int FUN_03073ebc(byte *param_1,uint *param_2,undefined4 param_3,code *param_4)
...
LAB_03073f94:
      ...
      if (bVar1 != 0x4c) {
        ...
        if (bVar1 != 0x6a) goto LAB_03073fa2;
        uVar13 = uVar13 | 0x200000;
      }
    }
    else if ((bVar1 != 0x74) && (bVar1 != 0x7a)) goto LAB_03073fa2;
    param_1 = param_1 + 1;
LAB_03073fa2:
    uVar4 = (uint)*param_1;
    ...
    while (!bVar22) {
      ...
      if (bVar21 == bVar23) {
        if (uVar4 == 0x70) {
          ...
          if (uVar4 == 0x67) break;
          if (uVar4 == 0x69) goto LAB_030740c0;
          if (uVar4 == 0x6e) {
          ...
          if (uVar4 != 0x6f) goto LAB_03073ff6;
          local_88 = (char *)0x8;
        }
        else {
          if (uVar4 == 0x73) {
          ...
          if (uVar4 == 0x75) {
            ...
            if (uVar4 != 0x78) goto LAB_03073ff6;
            local_88 = (char *)0x10;
          }
        }
LAB_0307415e:
...
LAB_030741dc:
        ...
        if (uVar4 == 0x58) {
          local_7c = s_0123456789ABCDEF_030742d4;
        }
        else {
          local_7c = s_0123456789abcdef_030742c0;
        }
        local_80 = &local_50;
        while( true ) {
          if (lVar24 == 0) break;
          lVar24 = FUN_0306d274((int)lVar24,(int)((ulonglong)lVar24 >> 0x20),local_88,0);
        ...
        if (-1 < (int)(uVar13 << 0xf)) {
          iVar3 = FUN_030745d2(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar3;
        }
        ...
        if ((int)(uVar13 << 0xf) < 0) {
          iVar5 = FUN_030745d2(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar5;
        }
...
LAB_03074050:
          ...
          iVar5 = FUN_030745d2(uVar4,uVar13,local_2c,param_4);
...
LAB_03074120:
      ...
      bVar22 = uVar4 == 0x45;
      if (!bVar22) goto code_r0x03073fb8;
    }
    goto LAB_03074302;
  }
  goto LAB_03073ff6;
code_r0x03073fb8:
  ...
  bVar22 = uVar4 == 0x46;
  if (!bVar22) goto code_r0x03073fbc;
  goto LAB_03073fa6;
code_r0x03073fbc:
  if (uVar4 != 0x47) {
LAB_03073ff6:
...
LAB_03074302:
  ...
  if ((puVar20[1] & 0x80000000) == 0) {
    if ((int)(uVar13 << 0x14) < 0) {
      local_38 = &DAT_030745a4;
    }
    else if ((uVar13 & 1) == 0) {
      local_38 = s_0123456789abcdef_030742c0 + 0x10;
    }
    else {
      local_38 = &DAT_030745a8;
    }
  }
  else {
    local_38 = &DAT_030745a0;
  }
...
LAB_0307436c:
    ...
    local_84 = (char *)0x0;
    FUN_03073d60(&local_50,auStack_70,uVar11,uVar12);
    local_7c = pcStack_48;
    local_88 = local_50;
...
LAB_03074436:
    ...
    if (uVar4 == 0x45) goto LAB_0307436c;
    if (uVar4 == 0x46) goto LAB_03074398;
    if (uVar4 == 0x47) goto LAB_030743e0;
  }
  else if (uVar4 == 0x66) {
LAB_03074398:
    local_84 = (char *)0x1;
    ...
    if (uVar4 != 0x67) goto LAB_0307446e;
LAB_030743e0:
    if ((int)pcVar16 < 1) {
      pcVar16 = (char *)0x1;
    }
    ...
    if (-1 < (int)(uVar13 << 0x1c)) {
      pcVar8 = pcStack_48;
      if ((int)pcVar16 <= (int)pcStack_48) goto LAB_0307441a;
      while( true ) {
...
LAB_0307441a:
    ...
    if (((int)pcVar16 <= (int)local_4c) || ((int)local_4c < -4)) goto LAB_03074436;
    if ((int)local_4c < 1) {
      local_78 = local_4c;
...
LAB_0307445a:
      ...
      if ((int)unaff_r10 < (int)pcVar16) goto LAB_0307445a;
    }
...
LAB_0307446e:
  ...
  if (local_80 != (char **)0x80000000) {
    ...
    while ((0 < iVar5 || (local_80 != (char **)0x0))) {
      local_80 = (char **)FUN_0306d4f6(local_80,10);
      pbVar15 = pbVar15 + -1;
...
LAB_030742e8:
  iVar5 = FUN_030745ac(uVar4,uVar13,local_2c,param_4);
  iVar14 = iVar14 + iVar5;
LAB_030742ee:
  param_1 = param_1 + 1;
  goto LAB_030742f2;
