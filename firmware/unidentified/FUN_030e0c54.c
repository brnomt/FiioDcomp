/**
 * FUN_030e0c54 @ 0x030e0c54
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


undefined8 FUN_030e0c54(int *param_1,int param_2,int param_3,uint param_4,uint param_5,int param_6)
    ...
    do {
      while( true ) {
        ...
        if ((int)uVar1 < 0) {
          ...
          uVar11 = FUN_030ddd0a(param_3,param_4,(int)lVar12,uVar7);
        }
        bVar8 = true;
        FUN_030dde18();
        if ((bool)uVar9 && !bVar8) {
