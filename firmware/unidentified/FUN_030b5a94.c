/**
 * FUN_030b5a94 @ 0x030b5a94
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


int FUN_030b5a94(byte *param_1,uint *param_2,undefined4 param_3,code *param_4)
...
LAB_030b5b6c:
      ...
      if (bVar1 != 0x4c) {
        ...
        if (bVar1 != 0x6a) goto LAB_030b5b7a;
        uVar13 = uVar13 | 0x200000;
      }
    }
    else if ((bVar1 != 0x74) && (bVar1 != 0x7a)) goto LAB_030b5b7a;
    param_1 = param_1 + 1;
LAB_030b5b7a:
    uVar4 = (uint)*param_1;
    ...
    while (!bVar22) {
      ...
      if (bVar21 == bVar23) {
        if (uVar4 == 0x70) {
          ...
          if (uVar4 == 0x67) break;
          if (uVar4 == 0x69) goto LAB_030b5c98;
          if (uVar4 == 0x6e) {
          ...
          if (uVar4 != 0x6f) goto LAB_030b5bce;
          local_88 = (char *)0x8;
        }
        else {
          if (uVar4 == 0x73) {
          ...
          if (uVar4 == 0x75) {
            ...
            if (uVar4 != 0x78) goto LAB_030b5bce;
            local_88 = (char *)0x10;
          }
        }
LAB_030b5d36:
...
LAB_030b5db4:
        ...
        if (uVar4 == 0x58) {
          local_7c = s_0123456789ABCDEF_030b5eac;
        }
        else {
          local_7c = s_0123456789abcdef_030b5e98;
        }
        local_80 = &local_50;
        while( true ) {
          if (lVar24 == 0) break;
          lVar24 = FUN_030ac7ec((int)lVar24,(int)((ulonglong)lVar24 >> 0x20),local_88,0);
        ...
        if (-1 < (int)(uVar13 << 0xf)) {
          iVar3 = FUN_030b61aa(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar3;
        }
        ...
        if ((int)(uVar13 << 0xf) < 0) {
          iVar5 = FUN_030b61aa(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar5;
        }
...
LAB_030b5c28:
          ...
          iVar5 = FUN_030b61aa(uVar4,uVar13,local_2c,param_4);
...
LAB_030b5cf8:
      ...
      bVar22 = uVar4 == 0x45;
      if (!bVar22) goto code_r0x030b5b90;
    }
    goto LAB_030b5eda;
  }
  goto LAB_030b5bce;
code_r0x030b5b90:
  ...
  bVar22 = uVar4 == 0x46;
  if (!bVar22) goto code_r0x030b5b94;
  goto LAB_030b5b7e;
code_r0x030b5b94:
  if (uVar4 != 0x47) {
LAB_030b5bce:
...
LAB_030b5eda:
  ...
  if ((puVar20[1] & 0x80000000) == 0) {
    if ((int)(uVar13 << 0x14) < 0) {
      local_38 = &DAT_030b617c;
    }
    else if ((uVar13 & 1) == 0) {
      local_38 = s_0123456789abcdef_030b5e98 + 0x10;
    }
    else {
      local_38 = &DAT_030b6180;
    }
  }
  else {
    local_38 = &DAT_030b6178;
  }
...
LAB_030b5f44:
    ...
    local_84 = (char *)0x0;
    FUN_030b5938(&local_50,auStack_70,uVar11,uVar12);
    local_7c = pcStack_48;
    local_88 = local_50;
...
LAB_030b600e:
    ...
    if (uVar4 == 0x45) goto LAB_030b5f44;
    if (uVar4 == 0x46) goto LAB_030b5f70;
    if (uVar4 == 0x47) goto LAB_030b5fb8;
  }
  else if (uVar4 == 0x66) {
LAB_030b5f70:
    local_84 = (char *)0x1;
    ...
    if (uVar4 != 0x67) goto LAB_030b6046;
LAB_030b5fb8:
    if ((int)pcVar16 < 1) {
      pcVar16 = (char *)0x1;
    }
    ...
    if (-1 < (int)(uVar13 << 0x1c)) {
      pcVar8 = pcStack_48;
      if ((int)pcVar16 <= (int)pcStack_48) goto LAB_030b5ff2;
      while( true ) {
...
LAB_030b5ff2:
    ...
    if (((int)pcVar16 <= (int)local_4c) || ((int)local_4c < -4)) goto LAB_030b600e;
    if ((int)local_4c < 1) {
      local_78 = local_4c;
...
LAB_030b6032:
      ...
      if ((int)unaff_r10 < (int)pcVar16) goto LAB_030b6032;
    }
...
LAB_030b6046:
  ...
  if (local_80 != (char **)0x80000000) {
    ...
    while ((0 < iVar5 || (local_80 != (char **)0x0))) {
      local_80 = (char **)FUN_030acb54(local_80,10);
      pbVar15 = pbVar15 + -1;
...
LAB_030b5ec0:
  iVar5 = FUN_030b6184(uVar4,uVar13,local_2c,param_4);
  iVar14 = iVar14 + iVar5;
LAB_030b5ec6:
  param_1 = param_1 + 1;
  goto LAB_030b5eca;
