/**
 * FUN_030e0db0 @ 0x030e0db0
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


int FUN_030e0db0(byte *param_1,uint *param_2,undefined4 param_3,code *param_4)
...
LAB_030e0e88:
      ...
      if (bVar1 != 0x4c) {
        ...
        if (bVar1 != 0x6a) goto LAB_030e0e96;
        uVar13 = uVar13 | 0x200000;
      }
    }
    else if ((bVar1 != 0x74) && (bVar1 != 0x7a)) goto LAB_030e0e96;
    param_1 = param_1 + 1;
LAB_030e0e96:
    uVar4 = (uint)*param_1;
    ...
    while (!bVar22) {
      ...
      if (bVar21 == bVar23) {
        if (uVar4 == 0x70) {
          ...
          if (uVar4 == 0x67) break;
          if (uVar4 == 0x69) goto LAB_030e0fb4;
          if (uVar4 == 0x6e) {
          ...
          if (uVar4 != 0x6f) goto LAB_030e0eea;
          local_88 = (char *)0x8;
        }
        else {
          if (uVar4 == 0x73) {
          ...
          if (uVar4 == 0x75) {
            ...
            if (uVar4 != 0x78) goto LAB_030e0eea;
            local_88 = (char *)0x10;
          }
        }
LAB_030e1052:
...
LAB_030e10d0:
        ...
        if (uVar4 == 0x58) {
          local_7c = s_0123456789ABCDEF_030e11c8;
        }
        else {
          local_7c = s_0123456789abcdef_030e11b4;
        }
        local_80 = &local_50;
        while( true ) {
          if (lVar24 == 0) break;
          lVar24 = FUN_030dda76((int)lVar24,(int)((ulonglong)lVar24 >> 0x20),local_88,0);
        ...
        if (-1 < (int)(uVar13 << 0xf)) {
          iVar3 = FUN_030e14c6(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar3;
        }
        ...
        if ((int)(uVar13 << 0xf) < 0) {
          iVar5 = FUN_030e14c6(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar5;
        }
...
LAB_030e0f44:
          ...
          iVar5 = FUN_030e14c6(uVar4,uVar13,local_2c,param_4);
...
LAB_030e1014:
      ...
      bVar22 = uVar4 == 0x45;
      if (!bVar22) goto code_r0x030e0eac;
    }
    goto LAB_030e11f6;
  }
  goto LAB_030e0eea;
code_r0x030e0eac:
  ...
  bVar22 = uVar4 == 0x46;
  if (!bVar22) goto code_r0x030e0eb0;
  goto LAB_030e0e9a;
code_r0x030e0eb0:
  if (uVar4 != 0x47) {
LAB_030e0eea:
...
LAB_030e11f6:
  ...
  if ((puVar20[1] & 0x80000000) == 0) {
    if ((int)(uVar13 << 0x14) < 0) {
      local_38 = &DAT_030e1498;
    }
    else if ((uVar13 & 1) == 0) {
      local_38 = s_0123456789abcdef_030e11b4 + 0x10;
    }
    else {
      local_38 = &DAT_030e149c;
    }
  }
  else {
    local_38 = &DAT_030e1494;
  }
...
LAB_030e1260:
    ...
    local_84 = (char *)0x0;
    FUN_030e0c54(&local_50,auStack_70,uVar11,uVar12);
    local_7c = pcStack_48;
    local_88 = local_50;
...
LAB_030e132a:
    ...
    if (uVar4 == 0x45) goto LAB_030e1260;
    if (uVar4 == 0x46) goto LAB_030e128c;
    if (uVar4 == 0x47) goto LAB_030e12d4;
  }
  else if (uVar4 == 0x66) {
LAB_030e128c:
    local_84 = (char *)0x1;
    ...
    if (uVar4 != 0x67) goto LAB_030e1362;
LAB_030e12d4:
    if ((int)pcVar16 < 1) {
      pcVar16 = (char *)0x1;
    }
    ...
    if (-1 < (int)(uVar13 << 0x1c)) {
      pcVar8 = pcStack_48;
      if ((int)pcVar16 <= (int)pcStack_48) goto LAB_030e130e;
      while( true ) {
...
LAB_030e130e:
    ...
    if (((int)pcVar16 <= (int)local_4c) || ((int)local_4c < -4)) goto LAB_030e132a;
    if ((int)local_4c < 1) {
      local_78 = local_4c;
...
LAB_030e134e:
      ...
      if ((int)unaff_r10 < (int)pcVar16) goto LAB_030e134e;
    }
...
LAB_030e1362:
  ...
  if (local_80 != (char **)0x80000000) {
    ...
    while ((0 < iVar5 || (local_80 != (char **)0x0))) {
      local_80 = (char **)FUN_030dda4a(local_80,10);
      pbVar15 = pbVar15 + -1;
...
LAB_030e11dc:
  iVar5 = FUN_030e14a0(uVar4,uVar13,local_2c,param_4);
  iVar14 = iVar14 + iVar5;
LAB_030e11e2:
  param_1 = param_1 + 1;
  goto LAB_030e11e6;
