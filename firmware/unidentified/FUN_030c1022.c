/**
 * FUN_030c1022 @ 0x030c1022
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


longlong FUN_030c1022(uint param_1,int param_2,uint param_3,uint param_4)
