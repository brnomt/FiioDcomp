/**
 * FUN_030df9fa @ 0x030df9fa
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


undefined4 FUN_030df9fa(int param_1,int param_2,int param_3)

{
  ...
  if (-1 < iVar5) {
    if (param_3 == 1 || param_3 == 2) {
      local_ac = 0;
      FUN_030ded62(iVar4,iVar4,*(undefined4 *)(param_1 + 0x30),*(undefined4 *)(param_1 + 8),
                   auStack_a8,0,param_3,iVar2,0);
    }
    else {
      FUN_030e0bbc(0,*(undefined4 *)(param_1 + 0x30),0xa0000000);
      FUN_030e0936(0);
      FUN_030de824(0,param_3,iVar2);
