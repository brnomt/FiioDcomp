/**
 * FUN_030826d0 @ 0x030826d0
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


longlong FUN_030826d0(uint param_1,int param_2,uint param_3,uint param_4)
