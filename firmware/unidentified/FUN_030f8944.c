/**
 * FUN_030f8944 @ 0x030f8944
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


int FUN_030f8944(byte *param_1,uint *param_2,undefined4 param_3,code *param_4)
...
LAB_030f8a1c:
      ...
      if (bVar1 != 0x4c) {
        ...
        if (bVar1 != 0x6a) goto LAB_030f8a2a;
        uVar13 = uVar13 | 0x200000;
      }
    }
    else if ((bVar1 != 0x74) && (bVar1 != 0x7a)) goto LAB_030f8a2a;
    param_1 = param_1 + 1;
LAB_030f8a2a:
    uVar4 = (uint)*param_1;
    ...
    while (!bVar22) {
      ...
      if (bVar21 == bVar23) {
        if (uVar4 == 0x70) {
          ...
          if (uVar4 == 0x67) break;
          if (uVar4 == 0x69) goto LAB_030f8b48;
          if (uVar4 == 0x6e) {
          ...
          if (uVar4 != 0x6f) goto LAB_030f8a7e;
          local_88 = (char *)0x8;
        }
        else {
          if (uVar4 == 0x73) {
          ...
          if (uVar4 == 0x75) {
            ...
            if (uVar4 != 0x78) goto LAB_030f8a7e;
            local_88 = (char *)0x10;
          }
        }
LAB_030f8be6:
...
LAB_030f8c64:
        ...
        if (uVar4 == 0x58) {
          local_7c = s_0123456789ABCDEF_030f8d5c;
        }
        else {
          local_7c = s_0123456789abcdef_030f8d48;
        }
        local_80 = &local_50;
        while( true ) {
          if (lVar24 == 0) break;
          lVar24 = FUN_030f68ba((int)lVar24,(int)((ulonglong)lVar24 >> 0x20),local_88,0);
        ...
        if (-1 < (int)(uVar13 << 0xf)) {
          iVar3 = FUN_030f905a(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar3;
        }
        ...
        if ((int)(uVar13 << 0xf) < 0) {
          iVar5 = FUN_030f905a(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar5;
        }
...
LAB_030f8ad8:
          ...
          iVar5 = FUN_030f905a(uVar4,uVar13,local_2c,param_4);
...
LAB_030f8ba8:
      ...
      bVar22 = uVar4 == 0x45;
      if (!bVar22) goto code_r0x030f8a40;
    }
    goto LAB_030f8d8a;
  }
  goto LAB_030f8a7e;
code_r0x030f8a40:
  ...
  bVar22 = uVar4 == 0x46;
  if (!bVar22) goto code_r0x030f8a44;
  goto LAB_030f8a2e;
code_r0x030f8a44:
  if (uVar4 != 0x47) {
LAB_030f8a7e:
...
LAB_030f8d8a:
  ...
  if ((puVar20[1] & 0x80000000) == 0) {
    if ((int)(uVar13 << 0x14) < 0) {
      local_38 = &DAT_030f902c;
    }
    else if ((uVar13 & 1) == 0) {
      local_38 = s_0123456789abcdef_030f8d48 + 0x10;
    }
    else {
      local_38 = &DAT_030f9030;
    }
  }
  else {
    local_38 = &DAT_030f9028;
  }
...
LAB_030f8df4:
    ...
    local_84 = (char *)0x0;
    FUN_030f87e8(&local_50,auStack_70,uVar11,uVar12);
    local_7c = pcStack_48;
    local_88 = local_50;
...
LAB_030f8ebe:
    ...
    if (uVar4 == 0x45) goto LAB_030f8df4;
    if (uVar4 == 0x46) goto LAB_030f8e20;
    if (uVar4 == 0x47) goto LAB_030f8e68;
  }
  else if (uVar4 == 0x66) {
LAB_030f8e20:
    local_84 = (char *)0x1;
    ...
    if (uVar4 != 0x67) goto LAB_030f8ef6;
LAB_030f8e68:
    if ((int)pcVar16 < 1) {
      pcVar16 = (char *)0x1;
    }
    ...
    if (-1 < (int)(uVar13 << 0x1c)) {
      pcVar8 = pcStack_48;
      if ((int)pcVar16 <= (int)pcStack_48) goto LAB_030f8ea2;
      while( true ) {
...
LAB_030f8ea2:
    ...
    if (((int)pcVar16 <= (int)local_4c) || ((int)local_4c < -4)) goto LAB_030f8ebe;
    if ((int)local_4c < 1) {
      local_78 = local_4c;
...
LAB_030f8ee2:
      ...
      if ((int)unaff_r10 < (int)pcVar16) goto LAB_030f8ee2;
    }
...
LAB_030f8ef6:
  ...
  if (local_80 != (char **)0x80000000) {
    ...
    while ((0 < iVar5 || (local_80 != (char **)0x0))) {
      local_80 = (char **)FUN_030f688e(local_80,10);
      pbVar15 = pbVar15 + -1;
...
LAB_030f8d70:
  iVar5 = FUN_030f9034(uVar4,uVar13,local_2c,param_4);
  iVar14 = iVar14 + iVar5;
LAB_030f8d76:
  param_1 = param_1 + 1;
  goto LAB_030f8d7a;
