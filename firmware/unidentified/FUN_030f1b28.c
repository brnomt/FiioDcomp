/**
 * FUN_030f1b28 @ 0x030f1b28
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


int FUN_030f1b28(byte *param_1,uint *param_2,undefined4 param_3,code *param_4)
...
LAB_030f1c00:
      ...
      if (bVar1 != 0x4c) {
        ...
        if (bVar1 != 0x6a) goto LAB_030f1c0e;
        uVar13 = uVar13 | 0x200000;
      }
    }
    else if ((bVar1 != 0x74) && (bVar1 != 0x7a)) goto LAB_030f1c0e;
    param_1 = param_1 + 1;
LAB_030f1c0e:
    uVar4 = (uint)*param_1;
    ...
    while (!bVar22) {
      ...
      if (bVar21 == bVar23) {
        if (uVar4 == 0x70) {
          ...
          if (uVar4 == 0x67) break;
          if (uVar4 == 0x69) goto LAB_030f1d2c;
          if (uVar4 == 0x6e) {
          ...
          if (uVar4 != 0x6f) goto LAB_030f1c62;
          local_88 = (char *)0x8;
        }
        else {
          if (uVar4 == 0x73) {
          ...
          if (uVar4 == 0x75) {
            ...
            if (uVar4 != 0x78) goto LAB_030f1c62;
            local_88 = (char *)0x10;
          }
        }
LAB_030f1dca:
...
LAB_030f1e48:
        ...
        if (uVar4 == 0x58) {
          local_7c = s_0123456789ABCDEF_030f1f40;
        }
        else {
          local_7c = s_0123456789abcdef_030f1f2c;
        }
        local_80 = &local_50;
        while( true ) {
          if (lVar24 == 0) break;
          lVar24 = FUN_030eebae((int)lVar24,(int)((ulonglong)lVar24 >> 0x20),local_88,0);
        ...
        if (-1 < (int)(uVar13 << 0xf)) {
          iVar3 = FUN_030f223e(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar3;
        }
        ...
        if ((int)(uVar13 << 0xf) < 0) {
          iVar5 = FUN_030f223e(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar5;
        }
...
LAB_030f1cbc:
          ...
          iVar5 = FUN_030f223e(uVar4,uVar13,local_2c,param_4);
...
LAB_030f1d8c:
      ...
      bVar22 = uVar4 == 0x45;
      if (!bVar22) goto code_r0x030f1c24;
    }
    goto LAB_030f1f6e;
  }
  goto LAB_030f1c62;
code_r0x030f1c24:
  ...
  bVar22 = uVar4 == 0x46;
  if (!bVar22) goto code_r0x030f1c28;
  goto LAB_030f1c12;
code_r0x030f1c28:
  if (uVar4 != 0x47) {
LAB_030f1c62:
...
LAB_030f1f6e:
  ...
  if ((puVar20[1] & 0x80000000) == 0) {
    if ((int)(uVar13 << 0x14) < 0) {
      local_38 = &DAT_030f2210;
    }
    else if ((uVar13 & 1) == 0) {
      local_38 = s_0123456789abcdef_030f1f2c + 0x10;
    }
    else {
      local_38 = &DAT_030f2214;
    }
  }
  else {
    local_38 = &DAT_030f220c;
  }
...
LAB_030f1fd8:
    ...
    local_84 = (char *)0x0;
    FUN_030f19cc(&local_50,auStack_70,uVar11,uVar12);
    local_7c = pcStack_48;
    local_88 = local_50;
...
LAB_030f20a2:
    ...
    if (uVar4 == 0x45) goto LAB_030f1fd8;
    if (uVar4 == 0x46) goto LAB_030f2004;
    if (uVar4 == 0x47) goto LAB_030f204c;
  }
  else if (uVar4 == 0x66) {
LAB_030f2004:
    local_84 = (char *)0x1;
    ...
    if (uVar4 != 0x67) goto LAB_030f20da;
LAB_030f204c:
    if ((int)pcVar16 < 1) {
      pcVar16 = (char *)0x1;
    }
    ...
    if (-1 < (int)(uVar13 << 0x1c)) {
      pcVar8 = pcStack_48;
      if ((int)pcVar16 <= (int)pcStack_48) goto LAB_030f2086;
      while( true ) {
...
LAB_030f2086:
    ...
    if (((int)pcVar16 <= (int)local_4c) || ((int)local_4c < -4)) goto LAB_030f20a2;
    if ((int)local_4c < 1) {
      local_78 = local_4c;
...
LAB_030f20c6:
      ...
      if ((int)unaff_r10 < (int)pcVar16) goto LAB_030f20c6;
    }
...
LAB_030f20da:
  ...
  if (local_80 != (char **)0x80000000) {
    ...
    while ((0 < iVar5 || (local_80 != (char **)0x0))) {
      local_80 = (char **)FUN_030eeb82(local_80,10);
      pbVar15 = pbVar15 + -1;
...
LAB_030f1f54:
  iVar5 = FUN_030f2218(uVar4,uVar13,local_2c,param_4);
  iVar14 = iVar14 + iVar5;
LAB_030f1f5a:
  param_1 = param_1 + 1;
  goto LAB_030f1f5e;
