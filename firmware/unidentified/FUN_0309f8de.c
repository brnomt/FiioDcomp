/**
 * FUN_0309f8de @ 0x0309f8de
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


void FUN_0309f8de(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if ((param_1 != 0 || (param_2 & 0x7fffffff) != 0) && (param_3 != 0 || (param_4 & 0x7fffffff) != 0)
    ...
    FUN_0309fb74((int)lVar1,(int)((ulonglong)lVar1 >> 0x20),uVar6 * 0x1000,uVar3 + uVar7,0,
