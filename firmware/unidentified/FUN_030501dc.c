...
uint FUN_030501dc(short *param_1,int param_2,int *param_3)
  ...
  do {
    ...
    if (bVar10) {
      ...
      if (iVar3 != 0) {
        do {
          ...
          iVar4 = FUN_0304ed3e(local_2c,0,uVar7);
          if (iVar4 != 0) {
            return 0x7fffffff;
          }
          uStack_64 = uVar7;
    ...
    if ((int)auStack_80[0] <= (int)auStack_80[1]) {
      do {
        ...
        iVar3 = FUN_0304fed0(local_30,local_2c,uVar7,auStack_78);
        if (iVar3 == 0) {
          return 0x7fffffff;
        }
        if (bVar2) {
    ...
    if (bVar2) {
      if ((uVar8 != uVar7) &&
         (iVar5 = FUN_0304fed0(local_30,local_2c,uVar8,auStack_78), uVar7 = uVar8, iVar5 == 0)) {
        return 0x7fffffff;
      }
