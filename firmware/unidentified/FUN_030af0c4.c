/**
 * FUN_030af0c4 @ 0x030af0c4
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


undefined4 FUN_030af0c4(int param_1,int param_2,int param_3)

{
  ...
  if (*(int *)(DAT_030af1dc + 0x24) == 0) {
    *(uint *)(param_2 + 0x8c) = local_18;
    iVar3 = FUN_030ae552(local_18 * 0xc);
    *(int *)(iVar1 + 0x30) = iVar3;
    if (iVar3 == 0) {
      return 0xfffffff9;
    }
    uVar2 = buffered_fread(iVar3,1,local_18 * 0xc,param_1);
