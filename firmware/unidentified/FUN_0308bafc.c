/**
 * FUN_0308bafc @ 0x0308bafc
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


void FUN_0308bafc(int param_1,int *param_2,int param_3,int param_4,int param_5,int param_6)

{
  ...
  uVar5 = FUN_0308ba56(iVar10 + iVar12 + iVar8 + iVar14 >> 1,iVar9 + iVar11 + iVar7 + iVar13 >> 1);
  *(undefined4 *)(param_3 + param_1 * 4) = uVar5;
  uVar5 = FUN_0308ba56(((iVar11 - iVar10) - iVar7) + iVar14 >> 1,
                       ((iVar9 + iVar12) - iVar8) - iVar13 >> 1);
  *(undefined4 *)(param_3 + (param_4 - param_1) * 4) = uVar5;
  uVar5 = FUN_0308ba56((iVar7 - (iVar10 + iVar11)) + iVar14 >> 1,
                       ((iVar12 - iVar9) - iVar8) + iVar13 >> 1);
  *(undefined4 *)(param_3 + (param_1 + param_4) * 4) = uVar5;
  uVar5 = FUN_0308ba56(((iVar11 - iVar9) + iVar7) - iVar13 >> 1,
