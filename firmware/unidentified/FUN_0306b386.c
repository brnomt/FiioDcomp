...
undefined4 FUN_0306b386(undefined4 param_1,int param_2)
...
LAB_0306b3a2:
  do {
    FUN_0306b340(param_2);
    FUN_0303da28(0x28);
    FUN_0303da28(10);
    FUN_030389f4(0,0x20,300);
    FUN_030390b0(0,0,auStack_2c,4,3);
    FUN_03038c1c(0);
    uVar1 = (uint)local_2a;
    if (uVar1 < 0xf) {
      if (iVar2 == 0) {
