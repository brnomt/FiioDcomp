/**
 * FUN_0309153c @ 0x0309153c
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


int FUN_0309153c(byte *param_1,uint *param_2,undefined4 param_3,code *param_4)
...
LAB_03091614:
      ...
      if (bVar1 != 0x4c) {
        ...
        if (bVar1 != 0x6a) goto LAB_03091622;
        uVar13 = uVar13 | 0x200000;
      }
    }
    else if ((bVar1 != 0x74) && (bVar1 != 0x7a)) goto LAB_03091622;
    param_1 = param_1 + 1;
LAB_03091622:
    uVar4 = (uint)*param_1;
    ...
    while (!bVar22) {
      ...
      if (bVar21 == bVar23) {
        if (uVar4 == 0x70) {
          ...
          if (uVar4 == 0x67) break;
          if (uVar4 == 0x69) goto LAB_03091740;
          if (uVar4 == 0x6e) {
          ...
          if (uVar4 != 0x6f) goto LAB_03091676;
          local_88 = (char *)0x8;
        }
        else {
          if (uVar4 == 0x73) {
          ...
          if (uVar4 == 0x75) {
            ...
            if (uVar4 != 0x78) goto LAB_03091676;
            local_88 = (char *)0x10;
          }
        }
LAB_030917de:
...
LAB_0309185c:
        ...
        if (uVar4 == 0x58) {
          local_7c = s_0123456789ABCDEF_03091954;
        }
        else {
          local_7c = s_0123456789abcdef_03091940;
        }
        local_80 = &local_50;
        while( true ) {
          if (lVar24 == 0) break;
          lVar24 = FUN_030826d0((int)lVar24,(int)((ulonglong)lVar24 >> 0x20),local_88,0);
        ...
        if (-1 < (int)(uVar13 << 0xf)) {
          iVar3 = FUN_03091c52(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar3;
        }
        ...
        if ((int)(uVar13 << 0xf) < 0) {
          iVar5 = FUN_03091c52(local_74,uVar13,local_2c,param_4);
          iVar14 = iVar14 + iVar5;
        }
...
LAB_030916d0:
          ...
          iVar5 = FUN_03091c52(uVar4,uVar13,local_2c,param_4);
...
LAB_030917a0:
      ...
      bVar22 = uVar4 == 0x45;
      if (!bVar22) goto code_r0x03091638;
    }
    goto LAB_03091982;
  }
  goto LAB_03091676;
code_r0x03091638:
  ...
  bVar22 = uVar4 == 0x46;
  if (!bVar22) goto code_r0x0309163c;
  goto LAB_03091626;
code_r0x0309163c:
  if (uVar4 != 0x47) {
LAB_03091676:
...
LAB_03091982:
  ...
  if ((puVar20[1] & 0x80000000) == 0) {
    if ((int)(uVar13 << 0x14) < 0) {
      local_38 = &DAT_03091c24;
    }
    else if ((uVar13 & 1) == 0) {
      local_38 = s_0123456789abcdef_03091940 + 0x10;
    }
    else {
      local_38 = &DAT_03091c28;
    }
  }
  else {
    local_38 = &DAT_03091c20;
  }
...
LAB_030919ec:
    ...
    local_84 = (char *)0x0;
    FUN_03091120(&local_50,auStack_70,uVar11,uVar12);
    local_7c = pcStack_48;
    local_88 = local_50;
...
LAB_03091ab6:
    ...
    if (uVar4 == 0x45) goto LAB_030919ec;
    if (uVar4 == 0x46) goto LAB_03091a18;
    if (uVar4 == 0x47) goto LAB_03091a60;
  }
  else if (uVar4 == 0x66) {
LAB_03091a18:
    local_84 = (char *)0x1;
    ...
    if (uVar4 != 0x67) goto LAB_03091aee;
LAB_03091a60:
    if ((int)pcVar16 < 1) {
      pcVar16 = (char *)0x1;
    }
    ...
    if (-1 < (int)(uVar13 << 0x1c)) {
      pcVar8 = pcStack_48;
      if ((int)pcVar16 <= (int)pcStack_48) goto LAB_03091a9a;
      while( true ) {
...
LAB_03091a9a:
    ...
    if (((int)pcVar16 <= (int)local_4c) || ((int)local_4c < -4)) goto LAB_03091ab6;
    if ((int)local_4c < 1) {
      local_78 = local_4c;
...
LAB_03091ada:
      ...
      if ((int)unaff_r10 < (int)pcVar16) goto LAB_03091ada;
    }
...
LAB_03091aee:
  ...
  if (local_80 != (char **)0x80000000) {
    ...
    while ((0 < iVar5 || (local_80 != (char **)0x0))) {
      local_80 = (char **)FUN_03082d22(local_80,10);
      pbVar15 = pbVar15 + -1;
...
LAB_03091968:
  iVar5 = FUN_03091c2c(uVar4,uVar13,local_2c,param_4);
  iVar14 = iVar14 + iVar5;
LAB_0309196e:
  param_1 = param_1 + 1;
  goto LAB_03091972;
