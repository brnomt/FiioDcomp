/**
 * FUN_0300bc92 @ 0x0300bc92
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


void FUN_0300bc92(uint param_1)

{
  ...
  *DAT_0300c0f0 = 0xffff;
  ...
  do {
    *DAT_0300c0f0 = 0xffff;
    sVar2 = (short)uVar10;
    FUN_02fffd02(1,auStack_a00,0x800);
    FUN_02fe750e(local_200,auStack_a00 + (short)(sVar2 + 1U) * 0x188,0x188);
    iVar9 = DAT_0300c0f8;
    if (local_200[0] == '\0') {
        ...
        if ((int)(short)local_4c - (int)(short)local_50 < (int)(uint)uVar7) {
          ...
          if (*(char *)(DAT_0300c100 + 5) == '\0') {
            ...
            *(undefined2 *)(iVar5 + 0x18) = 0x85;
            ...
            FUN_02fe750e(iVar5 + 0x50,auStack_78,iVar8 << 1);
            FUN_02fe750e(iVar5 + 0x22,auStack_16e,(iVar8 - iVar9) * 2);
