/**
 * FUN_0306d274 @ 0x0306d274
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


longlong FUN_0306d274(uint param_1,int param_2,uint param_3,uint param_4)
