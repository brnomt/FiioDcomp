/**
 * FUN_030eecee @ 0x030eecee
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


uint FUN_030eecee(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if (iVar4 < 0x40) {
    ...
    uVar11 = FUN_030eee94(uVar7,uVar9,0x40 - iVar4);
    uVar6 = (uint)(uVar11 >> 0x20);
    uVar5 = (uint)uVar11;
    lVar12 = FUN_030eeeb2(uVar7,uVar9,iVar4);
    ...
    if ((param_2 ^ uVar7) >> 0x14 != 0) {
      if (iVar2 == 0) {
        ...
        if (iVar4 < 2) {
          uVar7 = FUN_030eec4a(param_1,uVar7 + uVar8 * -0x100000 + 0x100000,uVar5,uVar6,0,
