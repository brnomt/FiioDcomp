/**
 * FUN_030281b6 @ 0x030281b6
 * Tags: unidentified
 * Auto-exported from Ghidra decompilation
 */


bool FUN_030281b6(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5,
                 int param_6,uint param_7,uint param_8,uint param_9,uint param_10,uint param_11,
                 uint param_12,undefined4 param_13,int param_14,uint param_15,uint param_16,
                 int param_17,undefined4 param_18,int param_19,uint param_20,undefined4 param_21,
                 undefined4 param_22,int param_23,int param_24,int param_25,undefined4 param_26,
                 int param_27)

{
  ...
  while( true ) {
    iVar5 = FUN_03011cac(param_1,param_2);
    uVar6 = FUN_03011cac(unaff_r10,unaff_r9);
    iVar7 = FUN_03011cac(param_20 << 0x10,uVar6);
    uVar13 = FUN_02ff8e94(iVar7 + unaff_r7 + iVar5);
    FUN_02ff8e32((int)uVar13,(int)((ulonglong)uVar13 >> 0x20),0xfffffff0);
    FUN_02ff8f6c();
    bVar1 = FUN_02ff8ee0();
    ...
    uVar6 = FUN_03011cac(unaff_r5,unaff_r9);
    iVar8 = FUN_03011cac(param_12 << 0x10,uVar6);
    uVar6 = FUN_03011cac(unaff_r10,unaff_r9);
    iVar9 = FUN_03011cac(param_11 << 0x10,uVar6);
    uVar13 = FUN_02ff8e94(iVar9 + iVar5 + iVar7 + iVar8);
    FUN_02ff8e32((int)uVar13,(int)((ulonglong)uVar13 >> 0x20),0xfffffff0);
    FUN_02ff8f6c();
    bVar2 = FUN_02ff8ee0();
    uVar6 = FUN_03011cac(unaff_r5,unaff_r6);
    ...
    bVar12 = param_6 + -1 < unaff_r4 + 1;
    uVar11 = (uint)*(byte *)(iVar8 + 3);
    if (bVar12) {
      uVar11 = (uint)bVar1;
    }
    ...
    iVar7 = FUN_02ff8ee0();
    unaff_r5 = (unaff_r4 * 0x10000 - iVar7) + 0x10000;
    uVar6 = FUN_03011cac(unaff_r5,unaff_r6);
    iVar8 = FUN_03011cac((uint)bVar1 << 0x10,uVar6);
    unaff_r10 = iVar7 + unaff_r4 * -0x10000;
    uVar6 = FUN_03011cac(unaff_r10,unaff_r6);
    iVar7 = FUN_03011cac(uVar11 << 0x10,uVar6);
    unaff_r7 = iVar8 + iVar7;
    unaff_r9 = iVar5 + unaff_r8 * -0x10000;
    param_2 = FUN_03011cac(unaff_r5,unaff_r9);
    param_1 = (uint)bVar2 << 0x10;
  }
LAB_0302830e:
  iVar5 = *(int *)(param_27 + 0x24) + 1;
  *(int *)(param_27 + 0x24) = iVar5;
  bVar12 = iVar5 != *(int *)(param_27 + 0x10);
  if (!bVar12) {
