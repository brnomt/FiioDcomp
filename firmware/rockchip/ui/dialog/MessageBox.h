...
_ATTR_MESSAGEBOX_BSS_   EXT UINT16    MessageBoxCurDisFrameIndex;
_ATTR_MESSAGEBOX_BSS_   EXT UINT16    MessageBoxUnsupportFrameIndex;

_ATTR_MESSAGEBOX_BSS_   EXT void     (*MessageBoxHook)(void);
