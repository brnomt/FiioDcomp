...
typedef volatile struct {
    ...
    UINT32 PWM0_PERIOD_HPR; //PWM  Channel 0 Period Register /HIGH Polarity Capture register    
    UINT32 PWM0_DUTY_LPR;   //PWM  Channel 0 DutyRegister /LOW Polarity Capture register   
    UINT32 PWM0_CTRL;       //Current value register
    //pwm1
    UINT32 PWM1_CNT;         //Main counter register 
    UINT32 PWM1_PERIOD_HPR; //PWM  Channel 1 Period Register /HIGH Polarity Capture register 
    UINT32 PWM1_DUTY_LPR;   //PWM  Channel 1 DutyRegister /LOW Polarity Capture register   
    UINT32 PWM1_CTRL;       //Current value register 
    //pwm2
    UINT32 PWM2_CNT;         //Main counter register 
    UINT32 PWM2_PERIOD_HPR; //PWM  Channel 2 Period Register /HIGH Polarity Capture register 
    UINT32 PWM2_DUTY_LPR;   //PWM  Channel 2 DutyRegister /LOW Polarity Capture register   
    UINT32 PWM2_CTRL;       //Current value register
    //pwm3
    UINT32 PWM3_CNT;         //Main counter register 
    UINT32 PWM3_PERIOD_HPR; //PWM  Channel 3 Period Register /HIGH Polarity Capture register 
    UINT32 PWM3_DUTY_LPR;   //PWM  Channel 3 DutyRegister /LOW Polarity Capture register   
    UINT32 PWM3_CTRL;       //Current value register    

    UINT32 PWM_INTSTS;      //0x40 interrupt status register
    UINT32 PWM_INT_EN;      //0x44 interrupt enable register
...
#define     PWM_CHN0_INT_DISABLE           ((UINT32)0<<0) //0: Channel 0 Interrupt disabled 1: Channel 0 Interrupt enabled 
#define     PWM_CHN1_INT_DISABLE           ((UINT32)0<<1) //0: Channel 1 Interrupt disabled 1: Channel 1 Interrupt enabled 
#define     PWM_CHN2_INT_DISABLE           ((UINT32)0<<2) //0: Channel 2 Interrupt disabled 1: Channel 2 Interrupt enabled 
#define     PWM_CHN3_INT_DISABLE           ((UINT32)0<<3) //0: Channel 3 Interrupt disabled 1: Channel 3 Interrupt enabled 
