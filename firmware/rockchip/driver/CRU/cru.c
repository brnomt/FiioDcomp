...
/*
--------------------------------------------------------------------------------
  Function name : SetPllDefault()
  Author        :
  Description  : set 24MHz OSC output, Pll reset
  Input         :
  Return        :
    ...
    else
    {
        ...
        //configer PLL , wait stable
        {
            ...
            {// here is hook for freq change start
                ...
                Freq_VopTiming_Update(chip_freq.hclk_sys_core);
...
uint32 SetHclkCalCoreFreq(Clock_Source_Sel Clk_Source,UINT32 TargetFreqHz)
{
    ...
    if(Clk_Source == PLL_MUX_CLK)
    {
        ...
        div_num = Source_clk/TargetFreqHz;
        if (div_num > 0); div_num = div_num - 1;
        if (Source_clk / (div_num + 1) > 500000000) div_num++;
...
uint32 SetHclkSysCoreFreq(Clock_Source_Sel Clk_Source,UINT32 TargetFreqHz)
{
    ...
    if(Clk_Source == PLL_MUX_CLK)
    {
        ...
        div_num = Source_clk/TargetFreqHz;
        if (div_num > 0) div_num = div_num - 1;
        if (Source_clk / (div_num + 1) > 250000000) div_num++;
...
uint32 SetPclkLogicPreFreq(UINT32 TargetFreqHz)
{
    ...
    for (i = 0; i < 4; i++)
    {
        if ((TargetFreqHz * (0x0001 << i)) >= Source_clk)
        {
            div_num = i;
            break;
        }
    ...
    chip_freq.pclk_logic_pre = Source_clk/(0x0001 << div_num);
   ...
   UINT32 RealFreq, Source_clk,div_num,ret;
    ...
    if(I2sId == I2S_CH1)
    {
        ...
        else if(Clk_Source == CLK_ACODEC_PLL)
        {
            ...
            CRU->CRU_CLKSEL_CON[3] = ((CLK_SEL_MASK_7F << 16) | 4) << 0;
    ...
    else if(I2sId == I2S_CH0)
    {
        ...
        else if(Clk_Source == CLK_ACODEC_PLL)
        {
            ...
            //div_num = Source_clk/TargetFreqHz - 1;
            CRU->CRU_CLKSEL_CON[4] = ((CLK_SEL_MASK_7F << 16) | 4) << 0;
...
/*
--------------------------------------------------------------------------------
  Function name : SetSdioFreq()
  Author        :
  Description   : set emmc clock para
...
uint32 SetUartFreq(UINT32 UartID,Clock_Source_Sel Clk_Source,UINT32 TargetFreqHz)
{
    ...
    if(UartID == UART_CH0)
    {
        if(Clk_Source == PLL_MUX_CLK)
        {
            ...
            chip_freq.uart_clk[UART_CH0] = Source_clk/(div_num + 1);
        ...
        return(chip_freq.uart_clk[UART_CH0]);
    }
    else if(UartID == UART_CH1)
    {
        if(Clk_Source == PLL_MUX_CLK)
        {
            Source_clk = chip_freq.armclk;
            ...
            chip_freq.uart_clk[UART_CH1] = Source_clk/(div_num + 1);
        ...
        return(chip_freq.uart_clk[UART_CH1]);
    }
    else if(UartID == UART_CH2)
    {
        if(Clk_Source == PLL_MUX_CLK)
        {
            Source_clk = chip_freq.armclk;
            ...
            chip_freq.uart_clk[UART_CH2] = Source_clk/(div_num + 1);
        ...
        return(chip_freq.uart_clk[UART_CH2]);
    }
    else if(UartID == UART_CH3)
    {
        if(Clk_Source == PLL_MUX_CLK)
        {
            Source_clk = chip_freq.armclk;
            ...
            chip_freq.uart_clk[UART_CH3] = Source_clk/(div_num + 1);
        }
        else if(Clk_Source == XIN24M)
        {
            Source_clk = 24*1000*1000;
        ...
        return(chip_freq.uart_clk[UART_CH3]);
    }
    else if(UartID == UART_CH4)
    {
        if(Clk_Source == PLL_MUX_CLK)
        {
            Source_clk = chip_freq.armclk;
            ...
            chip_freq.uart_clk[UART_CH4] = Source_clk/(div_num + 1);
        }
        else if(Clk_Source == XIN24M)
        {
            Source_clk = 24*1000*1000;
        ...
        return(chip_freq.uart_clk[UART_CH4]);
    }
    else if(UartID == UART_CH5)
    {
        if(Clk_Source == PLL_MUX_CLK)
        {
            Source_clk = chip_freq.armclk;
            ...
            chip_freq.uart_clk[UART_CH5] = Source_clk/(div_num + 1);
        }
        else if(Clk_Source == XIN24M)
        {
            Source_clk = 24*1000*1000;
        ...
        return(chip_freq.uart_clk[UART_CH5]);
    }
}
