...
READ API rk_err_t VopSetMcu_FIFO_WATERMARK(uint32 VopId,int full_watermark,int empty_watermark)
{
...
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetStart(uint32 VopId ,uint32 mode)
{
    VOP * pVop = VopPort(VopId);
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopEnableClk(uint32 VopId,uint32 IntType)
{
    VOP * pVop = VopPort(VopId);
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetMcuIdle(uint32 VopId,uint32 idleFlag)
{
    VOP * pVop = VopPort(VopId);
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API uint32 VopIntClear(uint32 VopId)
{
    VOP * pVop = VopPort(VopId);
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopReset(uint32 VopId)
{
    VOP * pVop = VopPort(VopId);
    pVop->VopMcuSRT = 0x01;
}
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetUvswap(uint32 VopId,uint32 mode)
{
     VOP * pVop = VopPort(VopId);
    pVop->VopMcuCon |= mode;
}
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetFifoMode(uint32 VopId, uint32 fifomode)
{
    VOP * pVop = VopPort(VopId);
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopDisableInt(uint32 VopId, uint32 IntType)
{
    VOP * pVop = VopPort(VopId);
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopEnableInt(uint32 VopId, uint32 IntType)
{
    VOP * pVop = VopPort(VopId);
    pVop->VopMcuIntEn |= IntType;
}
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API uint32 VopGetInt(uint32 VopId)
{
        VOP * pVop = VopPort(VopId);  
        uint32 IntStatus;
#if 1
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetYUVType(uint32 VopId, uint32 YuvType)
{
     VOP * pVop = VopPort(VopId);     
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetDisplayMode(uint32 VopId, uint32 DisplayMode)
{
     VOP * pVop = VopPort(VopId);     
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetDitherMode(uint32 VopId, uint32 DitherMode)
{
     VOP * pVop = VopPort(VopId);     
     pVop->VopMcuCon |= DitherMode;  
}
READ API rk_err_t VopSetHWMode(uint32 VopId, uint32 HWMode)
{
     VOP * pVop = VopPort(VopId);     
     pVop->VopMcuCon |= HWMode;  
}
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetSplit(uint32 VopId, uint32 mode)
{
     VOP * pVop = VopPort(VopId);     
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSetWidthHeight(uint32 VopId, uint32 Width, uint32 Height)
{
    VOP * pVop = VopPort(VopId);
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopReadData(uint32 VopId, uint32 * data)
{
     VOP * pVop = VopPort(VopId);
}
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopReadCmd(uint32 VopId, uint32 * cmd)
{
      VOP * pVop = VopPort(VopId);
}
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSendData(uint32 VopId, uint32 data)
{
     VOP * pVop = VopPort(VopId);
...
*******************************************************************************/
_CPU_NANOD_LIB_VOP_READ_
READ API rk_err_t VopSendCmd(uint32 VopId, uint32 cmd)
{
     VOP * pVop = VopPort(VopId);
     pVop->VopMcuCmd = cmd;
}
