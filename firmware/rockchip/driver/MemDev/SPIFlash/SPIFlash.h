...
extern uint32 SFlashReadOTP(uint32 ByteAddr, uint32 ByteSize, void *pData);

extern uint32 SFlashWriteOTP(uint32 ByteAddr, uint32 ByteSize, void *pData);
...
extern void SFlashSysProtSet(uint32 magic);

extern uint32 SFlashGetCapacity(uint8 lun);

extern int32 SFlashGetProductSn(void *pSn);
