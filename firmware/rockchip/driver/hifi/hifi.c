...
#if 1//def __CPU_NANOD_LIB_HIFI_C__
...
** Time: 20:10:41
*******************************************************************************/
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t Hifi_Clear_FUN_DONE_FLAG(UINT32 HifiId)
{
...
*******************************************************************************/
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t Hifi_Enable_FUN_DONE_FLAG(UINT32 HifiId)
{
    HIFIACC * pHifi = HifiPort(HifiId);
...
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t HIFITranData(int32 *pSrc, int32 *pDst, int count)
{
    int i;
...
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t HIFITranData_fifo(int32 *pSrc_t, int32 *pDst_t, int count_t, int32 *pSrc_r, int32 *pDst_r, int *count_r)
{
    int i;
    int sum_num = count_t;
...
READ API rk_err_t HIFI_DMA_M2M_Unregister()
{
...
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t HIFI_DMA_MEM_ACC(int *pSrc, int *pDst, int count)
{
    int i , j, total_size;
...
READ API rk_err_t HIFI_DMA_TO_register()
{
...
READ API rk_err_t HIFI_DMA_TO_Unregister()
{
    IntDisable2(INT_ID_DMA2);
    IntPendingClear2(INT_ID_DMA2);
    IntUnregister2(INT_ID_DMA2);
...
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t HIFI_DMA_TO_ACC(int *pSrc_t, int *pDst_t, int count, int *pSrc_r, int *pDst_r)
{
    int i , j, total_size;
...
*******************************************************************************/
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t Hifi_Set_ACC_XFER_Start(UINT32 HidiId, int count, int fun_type)
{
...
*******************************************************************************/
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t Hifi_Set_ACC_XFER_Disable(UINT32 HidiId, int count, int fun_type)
{
    HIFIACC * pHifi = HifiPort(HidiId);
...
*******************************************************************************/
_CPU_NANOD_LIB_HIFI_READ_
READ API RK_ERR_T Hifi_Get_ACC_Intsr(UINT32 HifiId, int mode)
{
    int res;
    HIFIACC * pHifi = HifiPort(HifiId);
...
*************************************************************000******************/
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t Hifi_Set_ACC_Intcr(UINT32 HifiId)
{
    HIFIACC * pHifi = HifiPort(HifiId);
...
*******************************************************************************/
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t Hifi_Set_ACC_Dmacr(UINT32 HifiId)
{
    HIFIACC * pHifi = HifiPort(HifiId);
...
*******************************************************************************/
_CPU_NANOD_LIB_HIFI_READ_
READ API rk_err_t Hifi_Set_ACC_clear(UINT32 HifiId)
{
    HIFIACC * pHifi = HifiPort(HifiId);
