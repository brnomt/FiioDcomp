...
#define USB_CTRL_SEL_PHY                ((uint32)(0) << 0)
#define USB_CTRL_SEL_NON_PHY            ((uint32)(1) << 0)
...
#define UTMI_XCVRSELECT_0               ((uint32)(0) << 4)
#define UTMI_XCVRSELECT_1               ((uint32)(1) << 4)
#define UTMI_XCVRSELECT_2               ((uint32)(2) << 4)
#define UTMI_XCVRSELECT_3               ((uint32)(3) << 4)
#define UTMI_XCVRSELECT_MASK            ((uint32)(3) << 4)

//Termination Select between FS/LS and HS Terminations
#define UTMI_TERMSELECT_FS_LS           ((uint32)(0) << 6)
#define UTMI_TERMSELECT_HS              ((uint32)(1) << 6)
...
#define I2S1_SEL_APAD         ((uint32)(0) << 13)
#define I2S1_SEL_BPAD         ((uint32)(1) << 13)
#define I2S1_SEL_MASK         ((uint32)(1) << 13)
