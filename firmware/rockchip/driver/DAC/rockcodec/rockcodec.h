...
*                         All rights reserved.
*
* File Name£º  rockcedec.h
*
* Description:
*
* History:      <author>          <time>        <version>
*               anzhiguo      2009-3-26          1.0
*    desc:    ORG.
********************************************************************************
*/
#if 1//(CODEC_CONFIG == CODEC_ROCKC)
...
#define ACODEC_TX_MODE              ((UINT32)(0x01))
#define ACODEC_RX_MODE              ((UINT32)(0x02))
typedef enum
{
    ACodec_I2S_TX    = ACODEC_TX_MODE,
    ACodec_I2S_RX    = ACODEC_RX_MODE,
    ACodec_I2S_TXRX  = (ACODEC_RX_MODE | ACODEC_TX_MODE),
}ACodecI2S_RxTx_t;
...
typedef enum
{
    Codecin_Sel_MIC1_MONO = 0x01,
    Codecin_Sel_MIC2_MONO = 0x02,
    Codecin_Sel_MIC_STERO = 0x03, //Codecin_Sel_MIC1_MONO | Codecin_Sel_MIC2_MONO
    Codecin_Sel_LINE1     = 0x04,
    Codecin_Sel_LINE2,
}CodecIn_sel_t;
...
typedef struct _SRUCT_FM_CODEC_CONFIG
{
    UINT8 FmRegVol;
    UINT8 ADCDigVol;
    UINT8 ADCMuxVol;
...
extern _ATTR_DRIVER_CODE_ SRUCT_CODEC_CONFIG CodecConfig_Europe[MAX_VOLUME + 1];
