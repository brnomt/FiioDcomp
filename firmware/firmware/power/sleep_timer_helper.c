/**
 * sleep_timer_helper @ 0x0304e108
 * Named via changelog-anchored lineage cluster (intro version).
 */

undefined4 sleep_timer_helper(undefined4 param_1,undefined4 *param_2,undefined4 *param_3)
