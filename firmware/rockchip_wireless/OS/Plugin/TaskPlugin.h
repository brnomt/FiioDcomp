...
#define TASK_PRIORITY_STREAM_CONTROL 19
#define TASK_PRIORITY_FILE_STREAM 19
...
//XXX
#define TASK_PRIORITY_TINYSVC_MDNS 17   // == TASK_PRIORITY_TCP
#define TASK_PRIORITY_RTSP 18
#define TASK_PRIORITY_RTP 18

//[0 =< device task < 10]
#define TASK_PRIORITY_LINE_IN 2
#define TASK_PRIORITY_BCORE  9
#define TASK_PRIORITY_SDIO   9
#define BT_HCI_DATA_RECV_TASK_PRIORITY   9
#define TASK_PRIORITY_USBOTG 9
#define TASK_PRIORITY_USBMSC 8
#define TASK_PRIORITY_USBSEVICE 2
#define TASK_PRIORITY_GUI    2
#define TASK_PRIORITY_MAINTASK 2
#define TASK_PRIORITY_CHARGE 2
#define TASK_PRIORITY_SHELL  1
