...
COMMON FUN void Recorder_ProcessDisplay(void)
{
    ...
    pstProgressBarContent.percentage = CurrTimer * 10000 / TotalTimer;
...
*******************************************************************************/
_APP_RECORD_RECOD_TASK_COMMON_
COMMON FUN rk_err_t RecodTask_ButtonCallBack(APP_RECIVE_MSG_EVENT evnet_type, uint32 event, void * arg, HGC pGc)
{
   RECOD_ASK_QUEUE RecodAskQueue;
