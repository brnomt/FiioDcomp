...
//Encode MP3
extern uint32  Load$$MP3_ENCODE_CODE$$Base;
extern uint32 Image$$MP3_ENCODE_CODE$$Base;
extern uint32 Image$$MP3_ENCODE_CODE$$Length;
...
FIRMWARE_INFO_T const ModuleInfo  =
{
    ...
    //MODUE_INFO_TABLE
    {
        (uint32)(MAX_SEGMENT_NUM),
        {
            ...
            //ENC MP3
            {
                (uint32)(&Load$$MP3_ENCODE_CODE$$Base),
                (uint32)(&Image$$MP3_ENCODE_CODE$$Base),
                (uint32)(&Image$$MP3_ENCODE_CODE$$Length),
