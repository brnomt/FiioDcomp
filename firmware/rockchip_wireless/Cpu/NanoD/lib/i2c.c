...
static void I2C_show_regs(eI2C_DEV i2cDev)
{
#if 0
    uint i;
    I2CReg_t *  pReg;
...
void I2CDisableIRQ(eI2C_DEV i2cDev)
{
    I2CReg_t *  pReg;
...
BOOL I2C_Read_SendACK(eI2C_DEV i2cDev,BOOL flg)
{
    return TRUE;
}
/*
...
--------------------------------------------------------------------------------
*/
BOOL I2C_ReadConfig(eI2C_DEV i2cDev,BOOL StartBit)
{
    BOOL ret = TRUE;
    I2CReg_t *  pReg;
...
BOOL I2C_Deinit(eI2C_DEV i2cDev )
{
    I2CReg_t *  pReg;
