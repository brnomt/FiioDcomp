...
extern BOOL I2C_Init(eI2C_DEV i2cDev,uint16 speed);
...
extern BOOL I2C_ReadConfig(eI2C_DEV i2cDev,BOOL StartBit);
extern BOOL I2C_Deinit(eI2C_DEV i2cDev);
extern BOOL I2C_Read_SendACK(eI2C_DEV i2cDev,BOOL flg);
